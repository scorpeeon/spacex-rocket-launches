...
/**
 * An activity representing a single SpaceXLaunch detail screen. This
        ...
        if (savedInstanceState == null) {
            ...
            val fragment = LaunchDetailFragment().apply {
                arguments = Bundle().apply {
                    putString(
                        LaunchDetailFragment.ARG_ITEM_ID,
                        intent.getStringExtra(LaunchDetailFragment.ARG_ITEM_ID)
                    )
                }
            }
