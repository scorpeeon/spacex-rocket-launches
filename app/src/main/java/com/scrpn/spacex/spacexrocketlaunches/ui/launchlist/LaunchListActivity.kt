...
class LaunchListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (launch_detail_container != null) {
                ...
                if (twoPane) {
                    val fragment = LaunchDetailFragment().apply {
                        arguments = Bundle().apply {
                            putString(LaunchDetailFragment.ARG_ITEM_ID, item.id)
                        }
                    }
                    ...
                    val intent = Intent(v.context, LaunchDetailActivity::class.java).apply {
                        putExtra(LaunchDetailFragment.ARG_ITEM_ID, item.id)
                    }
